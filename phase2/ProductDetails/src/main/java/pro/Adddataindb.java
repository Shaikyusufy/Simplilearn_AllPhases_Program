...
import com.hibernate.pro.HibernateUtill;
import com.hibernate.product.EProduct;

/**
 * Servlet implementation class Adddataindb
 */
@WebServlet("/add-product")
public class Adddataindb extends HttpServlet {
...
PrintWriter out = response.getWriter();
		...
		SessionFactory sf = HibernateUtill.beginSessionFactory();
